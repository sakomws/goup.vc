...
select has_function('claim_google_meet_recording_for_publish', array['bigint', 'bigint']::name[]);
...
select has_function('release_google_meet_recording_publish_claim', array['uuid', 'timestamp with time zone', 'text']::name[]);
