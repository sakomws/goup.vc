    ...
    loop
        ...
        begin
            insert into event (
                ...
                nullif(p_event->>'external_payment_instructions', ''),
                nullif(p_event->>'external_payment_url', ''),
                nullif(p_event->>'external_payment_window_hours', '')::integer,
                v_payment_currency_code,
                coalesce(nullif(p_event->>'tax_behavior', ''), 'inclusive'),
                coalesce(nullif(p_event->>'tax_calculation_mode', ''), 'none'),
