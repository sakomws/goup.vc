-- list_intentional_dating_opt_ins lists private dating opt-ins visible to admins.
create or replace function list_intentional_dating_opt_ins(
    p_alliance_id uuid,
...
returns jsonb as $$
    select coalesce(jsonb_agg(jsonb_build_object(
        ...
        'city', u.city,
        'country', u.country,
        'intentional_dating_goals', u.intentional_dating_goals,
        'intentional_dating_preferences', u.intentional_dating_preferences,
        'group_id', g.group_id,
        'group_name', g.name,
