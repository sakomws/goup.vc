...
pub(crate) async fn detail_page(
    ...
    gtm_handlers::detail_page(user, db, path, alliance_id, Some(group_id), GtmScope::Group).await
}

/// Creates a group-scoped lead.
#[instrument(skip_all, err)]
pub(crate) async fn add(
    ...
    gtm_handlers::add(user, db, alliance_id, Some(group_id), input).await
}

/// Updates a group lead.
#[instrument(skip_all, err)]
...
pub(crate) async fn run_agent(
    ...
    gtm_handlers::run_agent(user, db, alliance_id, Some(group_id), None, input).await
}

/// Runs an agent against one group lead.
#[instrument(skip_all, err)]
